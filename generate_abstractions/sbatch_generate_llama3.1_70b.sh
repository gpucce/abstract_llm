...
conda activate /leonardo_scratch/large/userexternal/gpuccett/Repos/llm_newest/conda_venv
module load gcc
...
python /leonardo_scratch/large/userexternal/gpuccett/Repos/abstact_llm/generate_abstractions/generate_llama.py \
    --model_name llama-3.1-405b-instruct-hf --n_samples 10000
